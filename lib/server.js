...
server.init = () => {
    ...
    server.httpServer.listen(config.port.http, () => console.log(`Server listening on: http://localhost:${config.port.http}/ | ${config.env}`));
    server.httpsServer.listen(config.port.https, () => console.log(`Server listening on: https://localhost:${config.port.https}/ | ${config.env}`));
};
